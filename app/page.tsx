...
export default function Home() {
  return (
    <main className="flex min-h-screen min-w-full flex-col items-center justify-between bg-white">
      ...
      <section className="w-full max-w-md mt-8 sm:hidden  text-center absolute z-10 bottom-6">
        <h2 className="text-3xl font-semibold text-gray-800">Download the App Now!</h2>
        <p className="text-gray-600 mt-4">Download Moya Barber app now. Available on both iOS and Android.</p>
